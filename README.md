...
**12 areas, 75 categories, 233 demo screens**, every one of them exercising a real
...
| 2D Graphics | 4 groups, 13 categories | 39 |
...
- **Backends:** `EASYGL` and `SDL_RENDERER` are both verified — 233/233 demos render on each.
