...
**12 areas, 75 categories, 229 demo screens**, every one of them exercising a real
...
- **Backends:** `EASYGL` and `SDL_RENDERER` are both verified — 229/229 demos render on each.
