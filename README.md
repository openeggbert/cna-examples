...
**12 areas, 75 categories, 234 demo screens**, every one of them exercising a real
...
- **Backends:** `EASYGL` and `SDL_RENDERER` are both verified — 234/234 demos render on each.
